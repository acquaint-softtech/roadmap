    ...
    return {
      ...
      get comments() {
        ...
        this.total = this.myForData.filter((item) => {
          return (item.text.toLowerCase().includes(this.search.toLowerCase()) || item.task__name.toLowerCase().includes(this.search.toLowerCase()) || item.user__email.toLowerCase().includes(this.search.toLowerCase()))
        }).length;
